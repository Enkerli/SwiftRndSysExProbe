...
class AudioUnitHostModel {
    ...
    // Must match the AudioComponents entry in SwiftRndSysExProbeExtension/Info.plist, or the
    // host app won't find the extension.
    init(type: String = "aumi", subType: String = "SxPr", manufacturer: String = "Enke") {
        self.type = type
